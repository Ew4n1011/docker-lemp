                ...
                <div class="column">
                    ...
                    <div class="content">
                        <ul>
                            ...
                            <li>
                                <?php
                                $link = mysqli_connect("db", "root", $_ENV['MARIADB_ROOT_PASSWORD'], null);

                                /* check connection */
                                if (mysqli_connect_errno()) {
                                    printf("MariaDB connection failed: %s", mysqli_connect_error());
                                } else {
                                    /* print server version */
                                    printf("MariaDB Server %s", mysqli_get_server_info($link));
                                }
                                /* close connection */
                                mysqli_close($link);
                                ?>
